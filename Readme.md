...
- Para personalizar el prompt y configuracion de zsh ir al [paso 11](https://github.com/mrd34o/Entorno-de-escritorio#11-zsh).
##### Fuente necesaria
...
- Siguiendo lo anterior, para tener en root la misma configuracion anterior se debe hacer lo mismo solo los  siguientes pasos [6. Nvim](https://github.com/mrd34o/Entorno-de-escritorio#6-nvim), [11. Zsh](https://github.com/mrd34o/Entorno-de-escritorio#11-zsh). 
