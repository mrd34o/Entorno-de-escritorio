# Generated by Powerlevel10k configuration wizard on 2026-01-12 at 15:43 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    #oogle_app_cred         # google application credentials (https://cloud.google.com/docs/authentication/production)
